...
-Complete the vote function. It takes a single argument, a string called name, representing the name of the candidate who was voted for.
...
Note: The database is in a .rar file that needs to be unzipped.
